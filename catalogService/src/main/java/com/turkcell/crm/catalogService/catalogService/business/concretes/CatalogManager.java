...
import com.turkcell.crm.catalogService.catalogService.kafka.producers.CatalogProducer;
...
public class CatalogManager implements CatalogService {
    ...
    public CreatedCatalogResponse add(CreateCatalogRequest createCatalogRequest) {
        ...
        CreateCatalogEvent event = modelMapperService.forResponse().map(savedCatalog, CreateCatalogEvent.class);
        catalogProducer.sendMessage(event);
